...
do 
        cd  $elm$i
        #tail -1  TOTENERGY.OUT|xargs echo $i"  " >> ../energie.out
	cat  out|grep "total energy"|tail -1|cut -c42-60|xargs echo "27.211396641308 *"|bc  |xargs  echo $i"  " >> ../energie.out
	cd ..
